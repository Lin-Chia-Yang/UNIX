...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 5b a4             	add    BYTE PTR [rbx-0x5c],bl
 37a:	2f                   	(bad)  
 37b:	fd                   	std    
 37c:	b9 b3 8e 8e 17       	mov    ecx,0x178e8eb3
 381:	96                   	xchg   esi,eax
 382:	5f                   	pop    rdi
 383:	ba 7f de 69 bc       	mov    edx,0xbc69de7f
 388:	0d                   	.byte 0xd
 389:	d9                   	.byte 0xd9
 38a:	b3 84                	mov    bl,0x84
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d 85 01 00 00 	lea    rdi,[rip+0x185]        # 1214 <main>
...
0000000000001159 <solver>:
    ...
    1198:	48 83 c0 18          	add    rax,0x18
    119c:	48 8b 00             	mov    rax,QWORD PTR [rax]
    119f:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28]
    11a3:	48 89 c6             	mov    rsi,rax
    11a6:	48 8d 05 57 0e 00 00 	lea    rax,[rip+0xe57]        # 2004 <_IO_stdin_used+0x4>
    11ad:	48 89 c7             	mov    rdi,rax
    11b0:	b8 00 00 00 00       	mov    eax,0x0
    11b5:	ff d2                	call   rdx
    11b7:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11bb:	48 83 c0 20          	add    rax,0x20
    11bf:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11c2:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28]
    11c6:	48 89 c6             	mov    rsi,rax
    11c9:	48 8d 05 34 0e 00 00 	lea    rax,[rip+0xe34]        # 2004 <_IO_stdin_used+0x4>
    11d0:	48 89 c7             	mov    rdi,rax
    11d3:	b8 00 00 00 00       	mov    eax,0x0
    11d8:	ff d2                	call   rdx
    11da:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11de:	48 83 c0 28          	add    rax,0x28
    11e2:	48 8b 00             	mov    rax,QWORD PTR [rax]
    11e5:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28]
    11e9:	48 89 c6             	mov    rsi,rax
    11ec:	48 8d 05 11 0e 00 00 	lea    rax,[rip+0xe11]        # 2004 <_IO_stdin_used+0x4>
    11f3:	48 89 c7             	mov    rdi,rax
    11f6:	b8 00 00 00 00       	mov    eax,0x0
    11fb:	ff d2                	call   rdx
    11fd:	90                   	nop
    11fe:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    1202:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
    1209:	00 00 
    120b:	74 05                	je     1212 <solver+0xb9>
    120d:	e8 4e fe ff ff       	call   1060 <__stack_chk_fail@plt>
    1212:	c9                   	leave  
    1213:	c3                   	ret    
...
0000000000001214 <main>:
    ...
    121c:	48 83 ec 20          	sub    rsp,0x20
    1220:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    1227:	00 00 
    1229:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    122d:	31 c0                	xor    eax,eax
    122f:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    1236:	69 6e 20 
    1239:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    1240:	00 00 00 
    1243:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    1247:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    124b:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    124f:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 1214 <main>
    1256:	48 89 d6             	mov    rsi,rdx
    1259:	48 89 c7             	mov    rdi,rax
    125c:	b8 00 00 00 00       	mov    eax,0x0
    1261:	e8 da fd ff ff       	call   1040 <printf@plt>
    1266:	48 8b 05 73 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d73]        # 3fe0 <printf@GLIBC_2.2.5>
    126d:	48 89 c7             	mov    rdi,rax
    1270:	e8 e4 fe ff ff       	call   1159 <solver>
    1275:	b8 00 00 00 00       	mov    eax,0x0
    127a:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    127e:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    1285:	00 00 
    1287:	74 05                	je     128e <main+0x7a>
    1289:	e8 d2 fd ff ff       	call   1060 <__stack_chk_fail@plt>
    128e:	c9                   	leave  
    128f:	c3                   	ret    
...
0000000000002000 <_IO_stdin_used>:
    ...
    2004:	25 6c 75 0a 00       	and    eax,0xa756c
...
000000000000200c <__GNU_EH_FRAME_HDR>:
    ...
    203f:	00 08                	add    BYTE PTR [rax],cl
...
0000000000002048 <__FRAME_END__-0xc8>:
    ...
    20f7:	00 1c f1             	add    BYTE PTR [rcx+rsi*8],bl
    20fa:	ff                   	(bad)  
    20fb:	ff                   	(bad)  
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 90 12 00 00 00    	add    BYTE PTR [rax+0x12],dl
...
0000000000000000 <.debug_info>:
  ...
  b6:	0d 05 58 00 00       	or     eax,0x5805
  bb:	00 14 12             	add    BYTE PTR [rdx+rdx*1],dl
  ...
  d7:	0e                   	(bad)  
  d8:	e0 00                	loopne da <__abi_tag-0x2b2>
  da:	00 00                	add    BYTE PTR [rax],al
  dc:	02 91 50 00 0d 66    	add    dl,BYTE PTR [rcx+0x660d0050]
  ...
  ff:	00 bb 00 00 00 00    	add    BYTE PTR [rbx+0x0],bh
 105:	00 00                	add    BYTE PTR [rax],al
 107:	00 01                	add    BYTE PTR [rcx],al
 109:	9c                   	pushf  
 10a:	10 e3                	adc    bl,ah
 10c:	00 00                	add    BYTE PTR [rax],al
 10e:	00 01                	add    BYTE PTR [rcx],al
 110:	05 1a 72 00 00       	add    eax,0x721a
...
0000000000000000 <.debug_line>:
  ...
  4d:	f2 05 07 e5 05 15    	repnz add eax,0x1505e507
  53:	08 ad 05 05 82 05    	or     BYTE PTR [rbp+0x5820505],ch
  59:	15 08 9f 05 05       	adc    eax,0x5059f08
  5e:	82                   	(bad)  
  5f:	05 15 08 9f 05       	add    eax,0x59f0815
  64:	05 82 08 9f 05       	add    eax,0x59f0882
  69:	01 21                	add    DWORD PTR [rcx],esp
  6b:	05 0c 08 5a ba       	add    eax,0xba5a080c
  70:	05 07 e5 05 02       	add    eax,0x205e507
  75:	08 ad 08 9f 05 09    	or     BYTE PTR [rbp+0x9059f08],ch
  7b:	e5 05                	in     eax,0x5
  7d:	01 59 02             	add    DWORD PTR [rcx+0x2],ebx
  80:	16                   	(bad)  
  81:	00 01                	add    BYTE PTR [rcx],al
  83:	01                   	.byte 0x1
...
0000000000000000 <.debug_line_str>:
   ...
   f:	63 79 6c             	movsxd edi,DWORD PTR [rcx+0x6c]
  12:	69 6e 2f 6c 61 62 30 	imul   ebp,DWORD PTR [rsi+0x2f],0x3062616c
  19:	34 00                	xor    al,0x0
  1b:	2f                   	(bad)  
  1c:	75 73                	jne    91 <__abi_tag-0x2fb>
  1e:	72 2f                	jb     4f <__abi_tag-0x33d>
  20:	69 6e 63 6c 75 64 65 	imul   ebp,DWORD PTR [rsi+0x63],0x6564756c
  27:	00 73 74             	add    BYTE PTR [rbx+0x74],dh
  2a:	64                   	fs
  2b:	69                   	.byte 0x69
